...
python src/run_classifier.py \
	...
	--decoder pool \
    --max_seq_length 128 \
    --load model/tobacco-new/tuneall/one-model-sepclass/best/model.pth \
    --output_dir eval-sepclass/tobacco-new/tuneall/$lang \
    --no_eval_dev
done

# for curated data
#--data_dir data/tobacco/20180723.translated-to-$lang \
