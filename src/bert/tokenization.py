...
PRETRAINED_VOCAB_ARCHIVE_MAP = {
    ...
    "https://s3.amazonaws.com/models.huggingface.co/bert/bert-base-multilingual-vocab.txt",
    'bert-base-chinese':
    "https://s3.amazonaws.com/models.huggingface.co/bert/bert-base-chinese-vocab.txt",
    'bert-base-multilingual-cased':
    "bert/multi_cased_L-12_H-768_A-12/vocab.txt",
}
...
class BertTokenizer(object):
    ...
    @classmethod
    def from_pretrained(cls, pretrained_model_name, do_lower_case):
        """
